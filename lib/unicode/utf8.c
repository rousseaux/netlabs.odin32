...
_K32CONV int utf8_wcstombs( const WCHAR *src, int srclen, char *dst, int dstlen )
{
    int ret = srclen;
...
_K32CONV int utf8_mbstowcs( int flags, const char *src, int srclen, WCHAR *dst, int dstlen )
{
    int len, count;
    unsigned int res;
