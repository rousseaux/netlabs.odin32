...
BEGIN
    ...
    BEGIN
        ...
        BEGIN
            ...
            VALUE "FileDescription", "MCI driver for Waveform audio\0"
            VALUE "FileVersion", "4.00\0"
            VALUE "InternalName", "MCIWAVE\0"
            VALUE "LegalCopyright", "Copyright (C) 1999-2000\0"
            VALUE "LegalTrademarks", "\0"
            VALUE "OriginalFilename", "MCIWAVE.DLL\0"
            VALUE "ProductName", "Odin32 - MCIWAVE\0"
