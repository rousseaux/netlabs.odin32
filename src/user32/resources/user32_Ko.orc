...
{
 MENUITEM "복귀(&R)\tAlt-F5", 61728
 MENUITEM "이동(&M)\tAlt-F7", 61456
 MENUITEM "크기 변경(&S)\tAlt-F8", 61440
 MENUITEM "아이콘 표시(&N)\tAlt-F9", 61472
 MENUITEM "전체 화면 표시(&F)\tAlt-F10", 61488
 MENUITEM SEPARATOR
 MENUITEM "닫기(&C)\tAlt-F4", 61536
 MENUITEM SEPARATOR
 MENUITEM "작업 전환(&W) ...\tCtrl-Esc", 61744
