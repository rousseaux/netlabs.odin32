...
static char *ntlm_GetUsernameArg(LPCWSTR userW, INT userW_length)
{
    ...
    unixcp_size =  WideCharToMultiByte(CP_ACP, WC_NO_BEST_FIT_CHARS,
    ...
    WideCharToMultiByte(CP_ACP, WC_NO_BEST_FIT_CHARS, userW, userW_length,
...
static char *ntlm_GetDomainArg(LPCWSTR domainW, INT domainW_length)
{
    ...
    WideCharToMultiByte(CP_ACP, WC_NO_BEST_FIT_CHARS, domainW,
        ...
        case SECPKG_CRED_OUTBOUND:
            {
                ...
                if(pAuthData != NULL)
                {
                    ...
                    {
                        ntlm_cred->pwlen = WideCharToMultiByte(CP_ACP,
    ...
    if((phContext == NULL) && (pInput == NULL))
    {
        ...
        if (!ntlm_cred->username_arg && !ntlm_cred->domain_arg)
        {
            ...
            if (ntlm_GetCachedCredential(pszTargetName, &cred))
            {
                ...
                {
                    pwlen = WideCharToMultiByte(CP_ACP,
