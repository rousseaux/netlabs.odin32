...
unsigned long MSVCRT(_beginthread)(_beginthread_start_routine_t,unsigned int,void*);
...
void        MSVCRT(_endthread)(void);
void        _endthreadex(unsigned int);
int         MSVCRT(_execl)(const char*,const char*,...);
int         MSVCRT(_execle)(const char*,const char*,...);
int         MSVCRT(_execlp)(const char*,const char*,...);
int         MSVCRT(_execlpe)(const char*,const char*,...);
int         MSVCRT(_execv)(const char*,char* const *);
int         MSVCRT(_execve)(const char*,char* const *,const char* const *);
int         MSVCRT(_execvp)(const char*,char* const *);
int         MSVCRT(_execvpe)(const char*,char* const *,const char* const *);
int         _getpid(void);
int         MSVCRT(_spawnl)(int,const char*,const char*,...);
int         MSVCRT(_spawnle)(int,const char*,const char*,...);
int         MSVCRT(_spawnlp)(int,const char*,const char*,...);
int         MSVCRT(_spawnlpe)(int,const char*,const char*,...);
int         MSVCRT(_spawnv)(int,const char*,const char* const *);
int         MSVCRT(_spawnve)(int,const char*,const char* const *,const char* const *);
int         MSVCRT(_spawnvp)(int,const char*,const char* const *);
int         MSVCRT(_spawnvpe)(int,const char*,const char* const *,const char* const *);
